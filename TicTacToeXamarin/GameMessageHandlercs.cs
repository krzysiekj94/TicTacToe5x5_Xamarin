        ...
        public override void HandleMessage(Message msg)
        {
            switch (msg.What)
            {
                ...
                case Constants.MESSAGE_WRITE:
                    ...
                    Toast.MakeText(Application.Context, "Me: " + writeMessage, ToastLength.Long).Show();
                    break;
                case Constants.MESSAGE_READ:
                    var readBuffer = (byte[])msg.Obj;
                    var readMessage = Encoding.ASCII.GetString(readBuffer);
                    Toast.MakeText(Application.Context, "Czytam: " + readMessage, ToastLength.Long).Show();
                    break;
                case Constants.MESSAGE_DEVICE_NAME:
                    string messagedevice = msg.Data.GetString(Constants.DEVICE_NAME);
                    Toast.MakeText(Application.Context, "Nazwa: " + messagedevice, ToastLength.Long).Show();
                    break;
